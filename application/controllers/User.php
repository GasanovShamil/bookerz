...
class User extends MY_Controller {
	...
	public function index()
	{
		...
		else
		{
			...
			$this->render('user/index', $this->data, null);
		}
	}

	
	
	//log the user with facebook
	public function facebook()
	{
		...
		if (isset($accessToken))
		{
			...
			try
			{
				$response = $this->fb->get('/me?fields=id,email,first_name,last_name');
			...
			if($this->form_validation->valid_email($user['email']))
			{
				...
				if($this->User_model->login_with_facebook($user))
				{
					redirect('/');
				}
				else
	...
	public function login()
	{
		...
		else
		{
			...
			$this->render('user/login', $this->data, null);
		}
	}
...
// 			$this->_render_page('auth/change_password', $this->data);
			$this->render('user/change_password', $this->data);
...
// 			$this->_render_page('auth/forgot_password', $this->data);
			$this->render('user/forgot_password', $this->data);
		}
		else
		{
...
// 				$this->_render_page('auth/reset_password', $this->data);
				$this->render('user/reset_password', $this->data);
			}
			else
			{
...
// 			$this->_render_page('auth/deactivate_user', $this->data);
			$this->render('user/deactivate_user', $this->data);
		}
		else
		{
...
//             $this->_render_page('auth/create_user', $this->data);
            $this->render('user/create_user', $this->data);
        }
    }
...
// 			$this->_render_page('auth/create_group', $this->data);
			$this->render('user/create_group', $this->data);
		}
	}
...
// 		$this->_render_page('auth/edit_group', $this->data);
		$this->render('user/edit_group', $this->data);
	}
