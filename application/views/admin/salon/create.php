<div class="contain">
    <div class="row row-offcanvas row-offcanvas-right">
        ...
        <?php
            ...
            echo form_open_multipart('createsalontempo/create');
        ?>
        <br><br>
        ...
        <input type="text" name="nb_max_user" placeholder="20">
        <br>
        <label>Nombre de signalement à partir duquel un utilisateur sera expulsé du salon</label>
        <input type="text" name="nb_max_report_needed" placeholder="3">
        <br>
